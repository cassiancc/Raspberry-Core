...
public class RaspberryEntityTypes {
    ...
    public static final RegistryObject<EntityType<GrapplingHookEntity>> GRAPPLING_HOOK = register(
            "grappling_hook", EntityType.Builder.<GrapplingHookEntity>createNothing(MobCategory.MISC).noSave().noSummon().sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(5).setCustomClientFactory(GrapplingHookEntity::new)
    );
