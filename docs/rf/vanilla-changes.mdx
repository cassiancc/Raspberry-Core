...
Ender eyes have been renamed to Awoken Exopearl. With no End dimenion, they required a new purpose. They now look for ruined structures such as shipwrecks, ruined nether portals, and bastian remnants. The awoken exopearl has a sister called the Spirited Exopearl, which looks for structures with spawners such as dungeons, mineshafts, and nether fortresses. Finding your first Blaze Spawner will be easier than ever! 

### Enderchest

The enderchest has been renamed to the Exovault. You'll find a very familiar recipe and texturing but for a colour palette change to match the Exokin, and the recipe now outputs a pair.
...
Each applied tablet results in one level of the enchantment. Holding shift over the tablet will tell you what each enchantment does as well as what it's max level will be.
